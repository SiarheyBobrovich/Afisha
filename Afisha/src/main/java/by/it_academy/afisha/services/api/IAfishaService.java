...
public interface IAfishaService {
     ...
     */
    void save(@Valid EventFilmDto newEventDto) throws ConstraintViolationException;
     ...
     * @throws ConstraintViolationException If class newEventDto is invalid
     */
    void save(@Valid EventConcertDto newEventDto) throws ConstraintViolationException;
     ...
     */
    void update(@Valid EventFilmDto updateEventDto, UUID uuid, LocalDateTime dtUpdate) throws ConstraintViolationException;
     ...
     * @throws ConstraintViolationException If class updateEventDto is invalid
     */
    void update(@Valid EventConcertDto updateEventDto, UUID uuid, LocalDateTime dtUpdate) throws ConstraintViolationException;
