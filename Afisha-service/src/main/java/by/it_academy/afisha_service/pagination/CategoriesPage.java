...
public class CategoriesPage {
    ...
    public CategoriesPage(int page,
                          int size,
                          int totalPages,
                          long totalElements,
                          boolean first,
    ...
    public static class Builder {
        ...
        public Builder setContent(List<Category> content) {
            this.content = content;
            return this;
        }

        public CategoriesPage build() {
            return new CategoriesPage(page, size, totalPages,totalElements, first, numberOfElements, last, content);
        }
    }
}
